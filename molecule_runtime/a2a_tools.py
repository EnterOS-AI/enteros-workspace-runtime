...
# Identity tool handlers — extracted to a2a_tools_identity. These two
# T4-tier MCP tools (``tool_get_runtime_identity`` +
# ``tool_update_agent_card``) originated in this repository's PR#17;
# the standalone runtime is the canonical edit point.
