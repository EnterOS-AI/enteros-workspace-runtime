...
try:
    from molecule_runtime.executor_helpers import sanitize_agent_error  # type: ignore[attr-defined]
...
class GoogleADKA2AExecutor(AgentExecutor):
    ...
    def _extract_text(self, context: RequestContext) -> str:
        ...
        from molecule_runtime.shared_runtime import extract_message_text
