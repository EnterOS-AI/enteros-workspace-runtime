...
def _git_clone_with_token(dest: Path, url: str, token: str) -> subprocess.CompletedProcess[str]:
    ...
    Mirror of the helper in ``check_consumer_runtime_drift.py``; see the
    long docstring there for the runtime#86 security context and the
    prior revert history this fix resurrects.
    """
